    ...
    <div class="row gx-0 align-items-center">
        ...
        <div class="col-lg-4 text-center text-lg-end">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                ...
                <div class="dropdown">
                    <a href="{{route('dashboard')}}" class="dropdown-toggle text-dark" data-bs-toggle="dropdown"><small><i class="fa fa-home text-primary me-2"></i> My Dashboard</small></a>
                    <div class="dropdown-menu rounded">
                        <a href="{{route('dashboard')}}" class="dropdown-item"><i class="fas fa-user-alt me-2"></i> My Profile</a>
